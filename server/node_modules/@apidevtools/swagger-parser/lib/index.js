...
const validateSchema = require("@apidevtools/swagger-parser/lib/validators/schema");
const validateSpec = require("@apidevtools/swagger-parser/lib/validators/spec");
const normalizeArgs = require("@apidevtools/json-schema-ref-parser/lib/normalize-args");
const util = require("@apidevtools/swagger-parser/lib/util");
const Options = require("@apidevtools/swagger-parser/lib/options");
