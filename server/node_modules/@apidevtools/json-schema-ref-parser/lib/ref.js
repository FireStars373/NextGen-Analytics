...
const { InvalidPointerError, isHandledError, normalizeError } = require("@apidevtools/json-schema-ref-parser/lib/util/errors");
const { safePointerToPath, stripHash, getHash } = require("@apidevtools/json-schema-ref-parser/lib/util/url");
