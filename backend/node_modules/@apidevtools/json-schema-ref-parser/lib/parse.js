...
const plugins = require("@apidevtools/json-schema-ref-parser/lib/util/plugins");
const { ResolverError, ParserError, UnmatchedParserError, UnmatchedResolverError, isHandledError } = require("@apidevtools/json-schema-ref-parser/lib/util/errors");
