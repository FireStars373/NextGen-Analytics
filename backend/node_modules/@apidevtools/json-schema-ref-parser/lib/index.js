...
const _parse = require("@apidevtools/json-schema-ref-parser/lib/parse");
const normalizeArgs = require("@apidevtools/json-schema-ref-parser/lib/normalize-args");
const resolveExternal = require("@apidevtools/json-schema-ref-parser/lib/resolve-external");
const _bundle = require("@apidevtools/json-schema-ref-parser/lib/bundle");
const _dereference = require("@apidevtools/json-schema-ref-parser/lib/dereference");
const url = require("@apidevtools/json-schema-ref-parser/lib/util/url");
const { JSONParserError, InvalidPointerError, MissingPointerError, ResolverError, ParserError, UnmatchedParserError, UnmatchedResolverError, isHandledError, JSONParserErrorGroup } = require("@apidevtools/json-schema-ref-parser/lib/util/errors");
